...
#origin_id = 970
#destination_ids = [2820]
#selected_time = "2006-10-31 08:00"

#==============================================================
def generate_routes_and_map(origin_id, destination_id, selected_time, K=5):

    map_output_path = "static/map_with_routes.html"
    ...
    # load edge list
    with open("datasets/processed/bidirectional_edges.json") as f:
