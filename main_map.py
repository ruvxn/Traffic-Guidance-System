...
# #THIS FILE HAS BEEN MEGRED TO THE main.py FILE 
# #DUE TO REDUNDANCY AND TO SIMPLIFY THE CODE BASE

# # main_map.py was originally used to visualise the routes generated by the A* algorithm


# # NOW IT is integrated within main.py to streamline the process of generating and visualising routes.
